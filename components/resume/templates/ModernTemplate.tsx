...
export function ModernTemplate({ data }: ModernTemplateProps) {
  ...
  const renderSection = (sectionKey: SectionKey) => {
    switch (sectionKey) {
      case 'summary':
        ...
        return (
          <div>
            <h2 className="text-base font-bold text-gray-900 uppercase tracking-wide mb-2 border-b border-gray-400 pb-1">
  ...
  return (
    <div className={`bg-white p-8 min-h-[1000px] text-gray-800 ${inter.className} ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="h-1 mt-4 mb-1" style={{ backgroundColor: primaryColor }} />
